...
set(WSPRRY_PICO_NETWORK_CLIENT_SOURCE "" CACHE PATH "Pinned WsprryPi 11.1 client checkout")
if(WSPRRY_PICO_NETWORK_CLIENT_SOURCE AND TARGET network_tls_driver)
    set(parent "${WSPRRY_PICO_NETWORK_CLIENT_SOURCE}")
    set(pin d333c69edc8a65bf59ae52603110996921f82ce1)
    ...
    if(NOT revision STREQUAL pin OR NOT dirty STREQUAL "")
        message(FATAL_ERROR "11.1 interoperability requires clean WsprryPi ${pin}")
    endif()
    ...
    add_custom_command(TARGET network_tls_driver POST_BUILD
        ...
        COMMAND ${CMAKE_COMMAND} -E create_symlink ${WSPRRY_PICO_TEST_CREDENTIAL_DIR} ${CMAKE_BINARY_DIR}/credentials)
