...
def main():
    ...
    if not re.search(r"^FLASH\s+0x10000000\s+0x003f3000\s+xr$", map_text, re.MULTILINE):
    ...
    print("Linked FLASH ends at 0x103f3000; access, BTstack, profile and standalone storage remain below the boot sector")
