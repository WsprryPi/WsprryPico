...
uses the same frozen, bounded runner and nominal native WTP plus twenty-second
HTTPS status workload as H0, with 3,720 seconds execution and 150 seconds cleanup.
...
One exactly 3,600-second FSKCW job containing 32 question marks, Morse
`..--..`, 384 events including the 1,000 ns final off interval. Dot and intra-gap
6465625000 ns; dash 19396875000 ns (DFCW marks all use dot duration); character gap
16016129000 ns. Mark 135,500 Hz, space/dash 135,495 Hz. FSKCW gaps remain RF-on at
...
- `packet_sha256`: `c408f5db396a50a6413334f05b7cc1eda22dab0040023454f28c435241931d41`
- `archive_sha256`: `64703198ac18527f65ca5b3d96d7839460559d846e5c76b6aa4cd165199cb82f`
- `root`: `/home/pi/phase11-5-r3-v2-hour-h1-20260913`
...
- `job_id`: `cec7fb4a873ab036a869324613230c3f`
- `dot_ns`: `6465625000`
- `character_gap_ns`: `16016129000`
...
Retired before execution: zero RF jobs. Use the separately reviewed H1A packet after the H0 HTTPS scheduler repair.
