...
| C2 concurrent status/authority | C1+B3+approved finite jobs | Persistent WTP plus browser reads in Loaded/Armed/Running; foreign mutation rejected, owner accurate; failed read becomes unknown | PARTIAL: actual Chrome Armed/Running/Complete with corrected production client; foreign HTTPS ABORT/RELEASE `NOT_OWNER`; production Loaded history retained | Chrome Loaded interval not captured; [2026-09-09 coverage](browser-production-coverage.md) preserves prior attempts |
