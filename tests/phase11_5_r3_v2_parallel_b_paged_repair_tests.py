...
from phase11_5_r3_v2_parallel_b_paged_repair import validate,prerequisite

class RepairTests(unittest.TestCase):
    def packet(self):
        p=Path(__file__).resolve().parents[1]/'build/phase11-5-r3-v2-parallel-b-deploy-bd2/stage/packet.json'
    ...
    def test_missing_fault_does_not_inspect_or_mutate_hardware(self):
        with patch('phase11_5_r3_v2_parallel_b_paged_repair.digest',return_value='0'*64),patch('subprocess.check_output') as process:
